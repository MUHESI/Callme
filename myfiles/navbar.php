            ...
            <div class="row">
                <div class="col-12">
                    <nav class="navbar navbar-expand-lg">
                        <!-- Logo -->
                        <!-- <a class="navbar-brand" href="index.php"><img src="img/core-img/logo1.png" alt="Logo" style="margin-top: 55px;"></a> -->
                        ...
                        <div class="collapse navbar-collapse" id="worldNav">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Association</a>
...
<a class="dropdown-item" href="#">Conseil d'amnistration</a>
...
<a class="dropdown-item" href="#">Historique</a>
                            ...
                            <a class="dropdown-item" href="#">Base de données</a>
                            ...
                            <a class="dropdown-item" href="#">Projets</a>
                               ...
                               <!--  <li class="nav-item">
                                    <a class="nav-link" href="pageRecherche.php">Recherche</a>
                                </li> -->
                                ...
                                <li class="nav-item">
                                    ...
                                    <a class="nav-link" href="traitements.php">Nos réalisations</a>
                                </li>
                                 <!-- <li class="nav-item">
